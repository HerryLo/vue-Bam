        ...
        <div class='js-sign-in-container'>
            <div class='sign_form'>
                <div class="input-prepend restyle js-normal">
                    <input placeholder="你的昵称" type="text" name="session[email_or_mobile_number]" id="session_email_or_mobile_number">
                    <i class="iconfont ic-user"></i>
                </div>
                <div class="input-prepend restyle js-normal">
                    <input placeholder="手机号" type="password" name="session[password]" id="session_password">
                ...
                <input type="submit" name="commit" value="注册" class="sign-in-button" data-disable-with="登录">
            </div>
        </div>
    </div>
  </div>
